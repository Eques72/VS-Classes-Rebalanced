...
Adjusts the balance of certain traits in the AllClasses mod to make them less extreme and improve overall balance. It also adds numerous new class-exclusive recipes to make some classes more immersive and useful.
...
## Compatibility
This mod has the same compatibility and incompatibility as AllClasses, except for mods that also modify the traits of the **Blackguard** or **Tailor** classes.

## Dependencies and Acknowledgements
This mod is a custom and unofficial patch for AllClasses by X.
Thank you for creating and supporting such a robust and elaborate mod!
X is in no way responsible for any issues or effects that this mod may have on your worlds.
